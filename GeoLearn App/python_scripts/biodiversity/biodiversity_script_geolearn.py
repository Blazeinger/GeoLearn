...
def get_mammal_db( path, animal_info, animal_boundaries ):
    ...
    if os.path.exists( BASE_DIR + 'biodiversity_mammal_db.csv' ) and os.path.exists( BASE_DIR + 'biodiversity_hist_db.csv' ):
        ...
        generator.generate_db_csv( path="/biodiversity/", server_run=True )
        generator = ""
    ...
    with open( BASE_DIR + "biodiversity_hist_db.csv", encoding="utf8" ) as csvFile:
